...
pairs = [
    [
        r"(.*) (kesulitan|kendala|tidak bisa|gak bisa) (.*) (lampiran|resep|resep digital|catatan|surat|rekomendasi)",
        ["Maaf, kamu mengalami kendala membuka lampiran dokter. Coba perbarui aplikasi  ke versi terbaru. Jika masih ada kendala, hubungi CS kami untuk mendapatkan bantuan."]
    ],
    [
    ...
    [
        ...
        5. Pilih profil pasien. Jika pasien belum mempunyai profil di aplikasi, pilih 'Profil Baru' pada bagian kanan atas layar, dan buat profil baru.
    ...
    [
        ...
        ["""
          ...
          1. Pilih 'Home Lab & Vaksinasi' pada halaman utama aplikasi aplikasi.
    ...
    [
        ...
        ["""Jika kamu menggunakan pengiriman instan, kamu dapat menghubungi driver dengan cara berikut:\n
            Pilih ‘Riwayat’ dari menu aplikasi  \n
    ...
    [
        r"^(.*)(layanan|fitur)(.*) |Halodoc(.*) (menawarkan/layanan/fitur)(.*)",
        ["""
        Kami hadir dengan solusi kesehatan digital lengkap yang bisa diakses dari ponselmu, di mana saja, dan kapan saja.
        ...
        Jelajahi juga layanan kami lainnya. Cukup pilih ‘Lihat Semua’ pada menu layanan dari beranda Aplikasi kamu.
        """,]
    ],
    [
        r"(.*)(belum tahu|tidak tahu)(.*)(konsultasi|berkonsultasi|obat|obatnya)(.*)(spesialis|dokter|obat|mana|apa)",
        ["""
        Jika kamu sakit atau butuh bantuan konsultasi, namun belum tahu perlu konsultasi ke spesialis apa atau beli obat apa, konsultasi dengan mitra dokter umum terlebih dahulu.

        Dokter umum kami dapat merujuk kamu ke spesialis online yang sesuai atau memberikanmu resep obat yang kamu butuhkan. Lihat cara untuk konsultasi di FAQ ini: Bagaimana cara konsultasi online di aplikasi?

        Setelah konsultasi dengan dokter dan mendapat resep, kamu bisa ke Toko Kesehatan untuk menebus obat yang kamu butuhkan. Lihat caranya di FAQ ini: Bagaimana cara menebus resep di aplikasi?

        Kamu juga bisa mencari obat berdasarkan gejala yang kamu alami. Berikut caranya:
        1. Pilih 'Toko Kesehatan' pada halaman utama aplikasi.
    ...
    [
        r"(.*)(belum tahu|tidak tahu)(.*)(konsultasi|berkonsultasi|obat|obatnya)",
        ["""
        Jika kamu sakit atau butuh bantuan konsultasi, namun belum tahu perlu konsultasi ke spesialis apa atau beli obat apa, konsultasi dengan mitra dokter umum terlebih dahulu.
    ...
    [
        r"(.*)(konsultasi|konsultasi online|chat)(.*)",
        ["""
        Chat dengan Dokter menyediakan layanan konsultasi online dengan berbagai dokter, spesialis, dan tenaga medis tepercaya. Kamu bisa konsultasi melalui chat, panggilan audio, dan panggilan video. Jika asuransimu disambungkan ke aplikasi, konsultasimu juga bisa ditanggung.
        ...
        Mohon diingat bahwa Aplikasi kami tidak ditujukan untuk situasi gawat darurat. Jika kamu dalam keadaan gawat darurat, segera hubungi nomor layanan medis darurat (Call Center 112) atau kunjungi fasilitas kesehatan terdekat.

        Ikuti langkah berikut untuk berkonsultasi online di aplikasi:
        1. Pilih 'Chat dengan Dokter' pada halaman utama aplikasi aplikasi.
    ...
    [
        ...
        ["""
        Berikut cara membeli obat di aplikasi:
        1. Pada halaman utama aplikasi, pilih “Toko Kesehatan”
    ...
    [
        ...
        ["""
        aplikasi menyediakan Home Lab & Vaksinasi, layanan untuk mendapatkan tindakan tes lab, vaksinasi, atau vitamin booster dari rumah atau di lokasi mana pun yang kamu pilih.
    ...
    [
        ...
        1. Pilih 'Home Lab & Vaksinasi' pada halaman utama aplikasi .
    ...
    [
        ...
        Mohon dipahami bahwa aplikasi kami tidak digunakan sebagai penanganan untuk kondisi darurat.
        """,]
    ],
    [
        r"(.*)(bertanya)(.*)",
        ["""Hai, Selamat datang di Chatbot Layanan Kesehatan, adakah yang dapat kami bantu?
        """,]
    ],
    [
        r"(.*)(chatbot|kamu|anda|lo)(.*)",
        ["""Hai, saya dapat menjawab berbagai pertanyaan anda terkait layanan kesehatan. Cobalah mulai dari "Layanan apa saja yang ditawarkan di sini?"
        """,]
    ],
    [
        r"(.*)",
